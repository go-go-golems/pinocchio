...
import { defineChatExtensions, defineTimelineProjector } from '@go-go-golems/chat-provider';
...
export const pinocchioAgentModeProjector = defineTimelineProjector({
...
export const pinocchioBackendToolProjector = defineTimelineProjector({
...
export const pinocchioWebChatProjectors = defineChatExtensions({
  name: 'pinocchio.web-chat.projectors',
  projectors: [pinocchioReasoningProjector, pinocchioAgentModeProjector, pinocchioBackendToolProjector],
});
