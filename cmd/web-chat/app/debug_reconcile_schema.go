...
func createDebugSQLiteSchema(ctx context.Context, db *sql.DB) error {
	stmts := []string{
		...
		`CREATE TABLE geppetto_records (record_id INTEGER PRIMARY KEY REFERENCES backend_records(id), ts TEXT, kind TEXT, provider TEXT, model TEXT, session_id TEXT, run_id TEXT, inference_id TEXT, turn_id TEXT, message_id TEXT, stage TEXT NOT NULL, event_type TEXT, info_message TEXT, provider_call_id TEXT, provider_call_index INTEGER, response_id TEXT, item_id TEXT, output_index INTEGER, summary_index INTEGER, choice_index INTEGER, content_block_index INTEGER, stream_kind TEXT, correlation_key TEXT, parent_correlation_key TEXT, tool_call_id TEXT, tool_call_index INTEGER, segment_id TEXT, segment_index INTEGER, segment_type TEXT, segment_status TEXT, text_len INTEGER, stop_reason TEXT, finish_class TEXT, duration_ms INTEGER, has_tool_calls INTEGER, usage_json TEXT, delta_len INTEGER, normalized_delta_len INTEGER, buffer_len INTEGER, error TEXT, object_json TEXT, event_json TEXT, metadata_json TEXT)`,
		`CREATE TABLE geppetto_provider_events (record_id INTEGER PRIMARY KEY REFERENCES geppetto_records(record_id), provider_event_type TEXT, response_id TEXT, item_id TEXT, output_index INTEGER, summary_index INTEGER, choice_index INTEGER, stream_kind TEXT, correlation_key TEXT, parent_correlation_key TEXT, tool_call_id TEXT, tool_call_index INTEGER, provider_call_id TEXT, provider_call_index INTEGER, object_json TEXT)`,
		`CREATE TABLE geppetto_emitted_events (record_id INTEGER PRIMARY KEY REFERENCES geppetto_records(record_id), geppetto_event_type TEXT, info_message TEXT, response_id TEXT, item_id TEXT, output_index INTEGER, summary_index INTEGER, choice_index INTEGER, stream_kind TEXT, correlation_key TEXT, parent_correlation_key TEXT, tool_call_id TEXT, tool_call_index INTEGER, provider_call_id TEXT, provider_call_index INTEGER, segment_id TEXT, segment_index INTEGER, segment_type TEXT, segment_status TEXT, event_json TEXT, metadata_json TEXT)`,
		`CREATE TABLE geppetto_inference_results (record_id INTEGER PRIMARY KEY REFERENCES geppetto_records(record_id), ts TEXT, provider TEXT, model TEXT, session_id TEXT, run_id TEXT, inference_id TEXT, turn_id TEXT, provider_call_id TEXT, provider_call_index INTEGER, response_id TEXT, stop_reason TEXT, finish_class TEXT, duration_ms INTEGER, has_tool_calls INTEGER, usage_json TEXT, correlation_key TEXT, parent_correlation_key TEXT)`,
		`CREATE TABLE geppetto_segments (record_id INTEGER PRIMARY KEY REFERENCES geppetto_records(record_id), ts TEXT, provider TEXT, model TEXT, session_id TEXT, run_id TEXT, inference_id TEXT, turn_id TEXT, message_id TEXT, provider_call_id TEXT, provider_call_index INTEGER, response_id TEXT, item_id TEXT, segment_id TEXT, segment_index INTEGER, segment_type TEXT, stream_kind TEXT, segment_status TEXT, text_len INTEGER, tool_call_id TEXT, tool_call_index INTEGER, correlation_key TEXT, parent_correlation_key TEXT, event_type TEXT, stage TEXT)`,
		...
		`CREATE INDEX idx_geppetto_records_provider_call ON geppetto_records(provider_call_id)`,
		`CREATE INDEX idx_geppetto_records_segment ON geppetto_records(segment_id)`,
		`CREATE INDEX idx_geppetto_records_correlation_key ON geppetto_records(correlation_key)`,
		`CREATE INDEX idx_geppetto_records_event_type ON geppetto_records(event_type)`,
		`CREATE INDEX idx_geppetto_inference_results_provider_call ON geppetto_inference_results(provider_call_id)`,
		`CREATE INDEX idx_geppetto_segments_segment ON geppetto_segments(segment_id)`,
		`CREATE INDEX idx_geppetto_segments_type ON geppetto_segments(segment_type)`,
