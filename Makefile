...
geppetto-lint: geppetto-lint-build
	GOWORK=off go vet -vettool=$(GEPPETTO_LINT_BIN) ./...
...
gosec:
	...
	GOWORK=off gosec -exclude=G101,G203,G304,G301,G306,G204,G302 -exclude-generated -exclude-dir=.history -exclude-dir=testdata -exclude-dir=pkg/sem/pb ./...
