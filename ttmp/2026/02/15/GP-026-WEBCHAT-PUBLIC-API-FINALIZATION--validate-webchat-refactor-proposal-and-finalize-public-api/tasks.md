...
- [x] Finalize docs, migration notes, and API contract tests for public release readiness
...
- [x] Reorganize package layout into stream/chat/timeline/http/bootstrap subpackages with stable public exports
