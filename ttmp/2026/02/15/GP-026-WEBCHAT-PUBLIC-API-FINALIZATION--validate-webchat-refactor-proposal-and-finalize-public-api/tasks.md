...
- [ ] ConversationService: replace direct user timeline store upsert with stream-published chat.message SEM event
- [ ] Add regression tests for mixed stream ingestion and chat.message projection flow
