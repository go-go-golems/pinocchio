...
- [x] Commit the shared CLI bootstrap slice.

## Slice 3: Repository-loaded command path

- [x] Trace how repository-loaded Pinocchio YAML commands receive Geppetto sections and ensure profile selection flows into final engine settings.
...
- [x] Commit the docs and example slice.
