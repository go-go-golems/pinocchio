...
3. [Static analysis guide](./design-doc/02-static-analysis-for-protocol-conformance.md) — reference only for this ticket.
4. [Finite-state model guide](./design-doc/03-finite-state-model-for-protocol-conformance.md) — reference only for this ticket.
5. [Investigation diary](./reference/01-investigation-diary.md)
6. [Tasks](./tasks.md)
