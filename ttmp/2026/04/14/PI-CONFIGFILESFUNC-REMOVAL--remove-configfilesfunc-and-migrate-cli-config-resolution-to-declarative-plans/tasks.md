...
- [x] Collapse duplicated config middleware assembly in `geppetto/pkg/cli/bootstrap/{profile_selection,engine_settings,inference_debug}.go` into one shared resolved-files helper and remove the dead `FromFiles(...)` fallback branch
